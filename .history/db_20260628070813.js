                ...
                return `
                    <div class="komentar-item">
                        ...
                        <div>${item.komentar}</
                            console.log(str)div>
                        <div class="aksi-btn">
                            <button class="btn-edit" onclick="isiFormEdit('${item.id}', '${item.nama}', '${item.komentar}')">Edit</button>
                            <button class="btn-hapus" onclick="hapusKomentar('${item.id}')">Hapus</button>
                        </div>
                    </div>
                `;
            }).join('');
